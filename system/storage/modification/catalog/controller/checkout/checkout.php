...
class ControllerCheckoutCheckout extends Controller {
	...
	public function single() {
        ...
        if (!isset($this->request->post['product_id'])) $json = ['error_message' => 'product_id is required', 'error' => true];

        $products = $this->cart->getProducts();

        if(!$products) $json = ['error_message' => 'there is no product with such id is required', 'error' => true];
