...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
            ...
            $simCatId = $this->model_catalog_product->getProductsCat($product_id);
            $simCatId = $simCatId->row['category_id'];
            $simCat = array($simCatId);
            ...
            $results = $this->model_catalog_product->getProductsSim($setting);
