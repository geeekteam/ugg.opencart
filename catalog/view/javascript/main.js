...
$("a.scrollto").click(function () {
  ...
  $('.tt-filter-aside-cont').click(function(){
   if($(this).parent().is('.filter-aside-cont-open')){
    $(this).parent().removeClass('filter-aside-cont-open');
   }else{
    $(this).parent().addClass('filter-aside-cont-open');
   }
  });


  $('.tt-aside-catalog').click(function(){
   if($(this).parent().is('.aside-catalog-open')){
    $(this).parent().removeClass('aside-catalog-open');
   }else{
    $(this).parent().addClass('aside-catalog-open');
   }
  });
