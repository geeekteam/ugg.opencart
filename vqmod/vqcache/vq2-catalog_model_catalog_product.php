...
class ModelCatalogProduct extends Model {
    ...
    public function getProductsCat($product_id) {
        $query = $this->db->query("SELECT category_id FROM " . DB_PREFIX . "product_to_category WHERE product_id LIKE ".$product_id );

        return $product_cat = $query;
    }

    public function getProductsSim($setting) {
    ...
    public function getAllProductFilters($filter_id)
    {
        $query = $this->db->query("SELECT product_id FROM " . DB_PREFIX . "product_filter WHERE filter_id =".(int)$filter_id);
